...
public class LoginStudentActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if(edUser.getText().toString().trim().isEmpty()){
                    ...
                    try {
                        ...
                        student.setLogin(edUser.getText().toString().trim(), edPassword.getText().toString().trim());
                        Cursor res = db.isStudent(student);
                        ...
                        if(res.getCount() == 0) {
                            ...
                            while(res.moveToNext()) {
                                ...
                                db.recordLogin(student.getUsername(), "student");
                                Intent i = new Intent(LoginStudentActivity.this, StudentMenuDrawerActivity.class);
                                startActivity(i);
                                finishAffinity();
                            }
                        }
    ...
    public void goStudentMenu(View v) {
        Intent i = new Intent(LoginStudentActivity.this, LoginStudentActivity.class);
        startActivity(i);
    }

    public void goHome(View v) {
        Intent i = new Intent(LoginStudentActivity.this, MainActivity.class);
        startActivity(i);
    }
}
